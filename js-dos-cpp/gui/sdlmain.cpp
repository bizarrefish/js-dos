...
#include <src/gui/dosbox_splash.h>
...
#
	...
	LOG_MSG("js-dos version %s", getVersion());
	LOG_MSG("Copyright 2002-2015 DOSBox Team, 2019 Alexander Guryanov, published under GNU GPL.");
	LOG_MSG("---");
